...
export default function SignIn() {
  ...
  return (
    <div className="auth-bg">
      <div className="relative z-10 w-full max-w-[420px] mx-4 bg-white rounded-2xl shadow-lg shadow-gray-200/60 px-8 py-9 fade-up">
        <div className="text-center mb-7">
          <h1 className="text-[22px] font-bold text-gray-900">Sign in</h1>
        ...
        <form onSubmit={e => { e.preventDefault(); navigate('/verify') }} className="space-y-4">
          ...
          <label className="flex items-center gap-2 cursor-pointer select-none">
            ...
            />
            <span className="text-[13px] text-gray-600 font-medium">Remember me</span>
          </label>
